...
<div class="admin-container">
    ...
    <div class="admin-header">
        <h1 class="admin-title">Novo Perfil</h1>
    </div>

    <form action="{{ route('admin.profiles.store') }}" method="POST" class="profile-form">
        @csrf

        @include('permissions::profiles._form', ['profile' => null])
